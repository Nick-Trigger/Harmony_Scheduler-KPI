...
def _compute_changeovers(problem: SchedulingProblem, solution: Solution, family_by_product: dict[str, str]) -> tuple[int, int]:
...
# %% Utilization
def _compute_utilization(problem: SchedulingProblem, solution: Solution) -> dict[str, int]:
...
def compute_kpis(problem: SchedulingProblem, solution: Solution) -> dict[str, Any]:
    ...
    changeover_count, changeover_minutes = _compute_changeovers(problem, solution, family_by_product)
